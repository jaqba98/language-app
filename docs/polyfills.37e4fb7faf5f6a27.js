...
(self.webpackChunkenglish_learning_fe =
  ...
  [461],
  {
    271: () => {
      ...
      function He(t, r, c, n, i) {
        return Zone.current.scheduleMacroTask(t, r, c, n, i);
      }
      const H = Q,
        be = typeof window < 'u',
        de = be ? window : void 0,
      ...
      function xe(t, r) {
        for (let c = t.length - 1; c >= 0; c--)
          'function' == typeof t[c] && (t[c] = je(t[c], r + '_' + c));
        return t;
      }
      function ze(t) {
        return (
      ...
      const qe =
        ...
        Pe =
          !('nw' in J) &&
          typeof J.process < 'u' &&
          '[object process]' === J.process.toString(),
        Ge = !Pe && !qe && !(!be || !de.HTMLElement),
        Xe =
          typeof J.process < 'u' &&
          '[object process]' === J.process.toString() &&
          !qe &&
        ...
        Ye = function (t) {
          ...
          let r = we[t.type];
          r || (r = we[t.type] = H('ON_PROPERTY' + t.type));
          const c = this || t.target || J,
            n = c[r];
          let i;
          return (
          ...
          (n.get = function () {
            ...
            if (u) {
              ...
              if (Z)
                return (
                  n.set.call(this, Z),
                  'function' == typeof C[_t] && C.removeAttribute(r),
                  Z
                );
            }
            return null;
      ...
      function Je(t, r, c) {
        if (r)
          ...
          for (let i = 0; i < n.length; i++) $e(t, n[i], c);
        }
      }
          ...
          (J[t] = function () {
            ...
            switch (i.length) {
              ...
              case 1:
                ...
                break;
              case 2:
                this[ne] = new r(i[0], i[1]);
                break;
              case 3:
                this[ne] = new r(i[0], i[1], i[2]);
                break;
              case 4:
                this[ne] = new r(i[0], i[1], i[2], i[3]);
                break;
              default:
      ...
      function le(t, r, c) {
        let n = t;
        for (; n && !n.hasOwnProperty(r); ) n = Ie(n);
        !n && t[r] && (n = t);
        const i = H(r);
        let u = null;
        if (
          n &&
          (!(u = n[i]) || !n.hasOwnProperty(i)) &&
          ((u = n[i] = n[r]), ze(n && ye(n, r)))
        ) {
          const E = c(u, i, r);
          (n[r] = function () {
      ...
      function Tt(t, r, c) {
        ...
        n = le(
          ...
          u =>
            function (_, E) {
              const p = c(_, E);
              return p.cbIdx >= 0 && 'function' == typeof E[p.cbIdx]
                ? He(p.name, E[p.cbIdx], p, i)
                : u.apply(_, E);
            },
        );
      }
      ...
      const pt = { useG: !0 },
        ...
        tt = H('propagationStopped');
      function nt(t, r) {
        const c = (r ? r(t) : t) + ae,
          n = (r ? r(t) : t) + ce,
          i = pe + c,
          u = pe + n;
        (te[t] = {}), (te[t][ae] = i), (te[t][ce] = u);
      }
      function mt(t, r, c, n) {
        const i = (n && n.add) || Le,
          u = (n && n.rm) || Me,
          _ = (n && n.listeners) || 'eventListeners',
          E = (n && n.rmAll) || 'removeAllListeners',
          p = H(i),
          C = '.' + i + ':',
          T = 'prependListener',
          Z = '.' + T + ':',
        ...
        function j(b, h, F) {
          ...
          const z = b || h.target || t,
            Y = z[te[h.type][F ? ce : ae]];
          if (Y) {
            const B = [];
            if (1 === Y.length) {
              const g = P(Y[0], z, h);
        ...
        function re(b, h) {
          if (!b) return !1;
          let F = !0;
          h && void 0 !== h.useG && (F = h.useG);
          const z = h && h.vh;
          let Y = !0;
          h && void 0 !== h.chkDup && (Y = h.chkDup);
          let B = !1;
          h && void 0 !== h.rt && (B = h.rt);
          let g = b;
          for (; g && !g.hasOwnProperty(i); ) g = Ie(g);
          if ((!g && b[i] && (g = b), !g || g[p])) return !1;
          const U = h && h.eventNameToString,
            ...
            K = (g[H(E)] = g[E]);
          let q;
          h && h.prepend && (q = g[H(h.prepend)] = g[h.prepend]);
          const $ = F
              ? function (s) {
                  if (!O.isExisting)
                    return w.call(
            ...
            A = F
              ? function (s) {
                  if (!s.isRemoved) {
                    const l = te[s.eventName];
                    let k;
                    l && (k = l[s.capture ? ce : ae]);
                    const R = k && s.target[k];
                    if (R)
            ...
            ke =
              h && h.diff
                ...
                : function (s, l) {
                    const k = typeof l;
                    return (
                      ('function' === k && s.callback === l) ||
                      ('object' === k && s.originalDelegate === l)
                    );
                  },
            he = Zone[H('UNPATCHED_EVENTS')],
            Se = t[H('PASSIVE_EVENTS')],
            a = function (s, l, k, R, y = !1, I = !1) {
              return function () {
                const L = this || t;
                let M = arguments[0];
                h &&
                ...
                if (z && !z(s, G, L, arguments)) return;
                const fe = _e && !!Se && -1 !== Se.indexOf(M),
                  se = (function f(s) {
                ...
                return (
                  ...
                  (oe.capture = Be),
                  (oe.eventName = M),
                  V && (oe.originalDelegate = G),
                  I ? ge.unshift(oe) : ge.push(oe),
                  y ? L : void 0
                );
              };
            };
          return (
            ...
            (g[u] = function () {
              ...
              const k = arguments[2],
                ...
                y = arguments[1];
              if (!y) return v.apply(this, arguments);
              if (z && !z(v, y, s, arguments)) return;
              const I = te[l];
              let L;
              I && (L = I[R ? ce : ae]);
              const M = L && s[L];
        ...
        let X = [];
        for (let b = 0; b < c.length; b++) X[b] = re(c[b], n);
        return X;
      }
      function rt(t, r) {
        if (!r) {
              ...
              if ('function' == typeof Z[0]) {
                ...
                Z[0] = function () {
                  try {
                    ...
                    P.isPeriodic ||
                      ('number' == typeof P.handleId
                        ? delete _[P.handleId]
                        : P.handleId && (P.handleId[Re] = null));
                  }
                };
                const W = He(r, Z[0], P, E, p);
                if (!W) return W;
      ...
      function Ot(t, r, c, n, i) {
        ...
        (r[n] = function (E, p, C) {
          ...
          t.attachOriginToPatched(r[n], _);
      }
      const it = (function Oe() {
        const t = globalThis,
          r = !0 === t[Q('forceDuplicateZoneCheck')];
        if (t.Zone && (r || 'function' != typeof t.Zone.__symbol__))
          ...
          (t.Zone ??= (function We() {
            ...
            let n = (() => {
              class N {
                ...
                static assertZonePatched() {
                  if (ee.Promise !== O.ZoneAwarePromise)
                    throw new Error(
                ...
                get(e) {
                  const o = this.getZoneWith(e);
                  if (o) return o._properties[e];
                }
                getZoneWith(e) {
                  let o = this;
                  for (; o; ) {
                    if (o._properties.hasOwnProperty(e)) return o;
                    o = o._parent;
                  }
                  return null;
                }
                ...
                wrap(e, o) {
                  ...
                  const m = this._zoneDelegate.intercept(this, e, o),
                    D = this;
                  return function () {
                    return D.runGuarded(m, this, arguments, o);
                  };
                }
                run(e, o, m, D) {
                ...
                runTask(e, o, m) {
                  ...
                  try {
                    ...
                    e.state !== X &&
                      e.state !== Y &&
                      (e.type == U || (e.data && e.data.isPeriodic)
                        ? D && e._transitionTo(h, F)
                        : ((e.runCount = 0),
                          this._updateTaskCount(e, -1),
                          D && e._transitionTo(X, F, X))),
                      (v = v.parent),
                      (S = $);
                  }
                }
                scheduleTask(e) {
                  ...
                  e._transitionTo(b, X);
                  const o = [];
                  (e._zoneDelegates = o), (e._zone = this);
                  try {
                    e = this._zoneDelegate.scheduleTask(this, e);
                  } catch (m) {
                    throw (
                      (e._transitionTo(Y, b, X),
                ...
                scheduleEventTask(e, o, m, D, $) {
                  return this.scheduleTask(new _(U, e, o, m, D, $));
                }
                cancelTask(e) {
                  if (e.zone != this)
                    throw new Error(
                  ...
                  if (e.state === h || e.state === F) {
                    e._transitionTo(z, h, F);
                    try {
            ...
            class u {
              ...
              hasTask(d, e) {
                try {
                  ...
                  this.handleError(d, o);
                }
              }
              _updateTaskCount(d, e) {
            ...
            class _ {
              ...
              static invokeTask(d, e, o) {
                d || (d = this), K++;
                try {
                  return d.runCount++, d.zone.runTask(d, e, o);
                } finally {
                  1 == K && x(), K--;
                }
              }
              ...
              cancelScheduleRequest() {
                this._transitionTo(X, b);
              }
              _transitionTo(d, e, o) {
                if (this._state !== e && this._state !== o)
                  throw new Error(
                    `${this.type} '${
                      this.source
                    }': can not transition to '${d}', expecting state '${e}'${
                      o ? " or '" + o + "'" : ''
                    }, was '${this._state}'.`,
                  );
                (this._state = d),
            ...
            let P,
              ...
              Z = !1;
            function j(N) {
              if ((P || (ee[p] && (P = ee[p].resolve(0))), P)) {
                let d = P[C];
                d || (d = P.then), d.call(P, N);
              } else ee[E](N, 0);
            }
            function W(N) {
              0 === K && 0 === T.length && j(x), N && T.push(N);
            }
            function x() {
              if (!Z) {
                for (Z = !0; T.length; ) {
                ...
                w.microtaskDrainDone(), (Z = !1);
              }
            }
            const re = { name: 'NO ZONE' },
              X = 'notScheduled',
              b = 'scheduling',
              h = 'scheduled',
              F = 'running',
            ...
            let v = { parent: null, zone: new n(null, null) },
              S = null,
              K = 0;
            function q() {}
      ...
      (function It(t) {
        (function St(t) {
          t.__load_patch('ZoneAwarePromise', (r, c, n) => {
            ...
            function N(f, a, s) {
              ...
              if (f[b] === g) {
                ...
                if (
                  ...
                  e(s), N(f, s[b], s[h]);
                else if (a !== O && 'function' == typeof k)
                  try {
                    k.call(s, l(v(f, a)), l(v(f, !1)));
                  } catch (R) {
                    l(() => {
                      N(f, !1, R);
                    })();
            ...
            const d = E('rejectionHandledHandler');
            function e(f) {
              if (f[b] === w) {
                try {
                  const a = c[d];
            ...
            (A.resolve = A.resolve),
              ...
              (A.race = A.race),
              (A.all = A.all);
            const Ce = (r[T] = r.Promise);
            r.Promise = A;
            const ke = E('thenPatched');
            function he(f) {
              const a = f.prototype,
                s = i(a, 'then');
          ...
          (function Nt(t) {
            t.__load_patch('util', (r, c, n) => {
              const i = Fe(r);
              (n.patchOnProperties = Je),
                (n.patchMethod = le),
                (n.bindArguments = xe),
                (n.patchMacroTask = Tt);
              ...
              r[_] && (r[u] = r[_]),
                r[u] && (c[u] = c[_] = r[u]),
                (n.patchEventPrototype = kt),
                (n.patchEventTarget = mt),
                (n.isIEOrEdge = yt),
                ...
                (n.ArraySlice = dt),
                (n.patchClass = me),
                (n.wrapWithCurrentZone = je),
                (n.filterProperties = ot),
        ...
        (function Ct(t) {
          t.__load_patch('legacy', r => {
            ...
            t.__load_patch('blocking', (r, c) => {
              ...
              for (let i = 0; i < n.length; i++)
                le(
                  ...
                  (_, E, p) =>
                    function (C, T) {
                      return c.current.run(_, r, T, p);
                    },
                );
            }),
            t.__load_patch('EventTarget', (r, c, n) => {
              (function wt(t, r) {
            ...
            t.__load_patch('IntersectionObserver', (r, c, n) => {
              me('IntersectionObserver');
            }),
            t.__load_patch('FileReader', (r, c, n) => {
              me('FileReader');
            }),
            ...
            t.__load_patch('XHR', (r, c) => {
              !(function C(T) {
                const Z = T.XMLHttpRequest;
                if (!Z) return;
                const P = Z.prototype;
                let W = P[Ze],
                  x = P[Ae];
                if (!W) {
                  const w = T.XMLHttpRequestEventTarget;
                  if (w) {
                    const v = w.prototype;
                    (W = v[Ze]), (x = v[Ae]);
                  }
                  ...
                  const q = (S[u] = () => {
                    if (S.readyState === S.DONE)
                      if (!v.aborted && S[_] && w.state === X) {
                        const d = S[c.__symbol__('loadfalse')];
                        if (0 !== S.status && d && d.length > 0) {
                          const e = w.invoke;
                          (w.invoke = function () {
                            const o = S[c.__symbol__('loadfalse')];
                            for (let m = 0; m < o.length; m++)
                              o[m] === w && o.splice(m, 1);
                            !v.aborted && w.state === X && e.call(w);
                          }),
                            d.push(w);
                        } else w.invoke();
                      } else !v.aborted && !1 === S[_] && (S[p] = !0);
                  });
                  return (
                    W.call(S, re, q),
                    S[n] || (S[n] = w),
